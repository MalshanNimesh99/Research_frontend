    ...
    <div>
      <Header />
        <div class="btContainer">
          <h3>Select Brain MRI Images to Detect Dementia</h3>
          <br></br>

      <input  class="fileinput" id="image-selector" type="file" onChange={handleImageChange} />
      <button class="btn btn-outline-primary btn-lg" id="predict-button" onClick={handlePredictClick}>Predict</button>
          ...
          <div class="container text-center">
            <div class="row align-items-center">
              <div class="col">
                ...
                <p class="para" >PROBABILITY : <span id="probability">{accuracy}</span></p>
              </div>
            </div>
          </div>
        </div><br></br>
